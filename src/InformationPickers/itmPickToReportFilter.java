 ...
 * @author Prabudha
 */
public class itmPickToReportFilter extends javax.swing.JFrame {

   reportFilter ob1;// check here
    Connection con = null;
    PreparedStatement pst = null;
    ResultSet rs = null;
    
    public itmPickToReportFilter(reportFilter ob1) {
        setIconImage();
...
public void tableLoad(){
        String sql2 = "SELECT ItemCode, ItemName FROM  itemmaster";
        try {
            ...
            Logger.getLogger(itmPickToReportFilter.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    /**
    ...
    private void btnSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchActionPerformed
        ...
        String sql = "SELECT ItemCode, ItemName FROM itemmaster where ItemName LIKE '%"+ ItmName  +"%' ";
        try {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(itmPickToReportFilter.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new itmPickToReportFilter(new reportFilter()).setVisible(true);
            }
        });
    }
