...
import MainInterfaces.InventoryReceipt;
 ...
 * @author Prabudha
 */
public class InventoryReceptDoNumber extends javax.swing.JFrame {

   InventoryReceipt ob1;// check here
    Connection con = null;
    PreparedStatement pst = null;
    ResultSet rs = null;
    
    public InventoryReceptDoNumber(InventoryReceipt ob1) {
        setIconImage();
...
public void tableLoad(){
        String sql2 = "SELECT DocumentNo, DocumentDate, RefNo FROM  inventrcpt";
        try {
            ...
            Logger.getLogger(InventoryReceptDoNumber.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    /**
    ...
    private void btnSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchActionPerformed
        ...
        String refNum = txtItemPick.getText();
        String sql = "SELECT DocumentNo, Documentdate, RefNo FROM inventrcpt where RefNo LIKE '%"+refNum+"%' ";
        try {
    ...
    private void btnItemPickActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnItemPickActionPerformed
        String y = txtItemPick.getText();
        ob1.setD(y);// call for Sales Order itemCode set Method
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InventoryReceptDoNumber.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InventoryReceptDoNumber(new InventoryReceipt()).setVisible(true);
            }
        });
    }
