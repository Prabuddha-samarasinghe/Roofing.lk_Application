 ...
 * @author Prabudha
 */
public class InventoryReturnDoNumber extends javax.swing.JFrame {
   ...
   InventoryReturn ob1;// check here
    ...
    public InventoryReturnDoNumber(InventoryReturn ob1) {
        setIconImage();
...
public void tableLoad(){
        String sql2 = "SELECT DocumentNo, DocumentDate, RefNo FROM  inventretn";
        try {
            ...
            Logger.getLogger(InventoryReturnDoNumber.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    /**
    ...
    private void btnSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchActionPerformed
        ...
        String sql = "SELECT DocumentNo, DocumentDate, RefNo FROM inventretn where RefNo LIKE '%"+refNum+"%' ";
        try {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InventoryReturnDoNumber.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InventoryReturnDoNumber(new InventoryReturn()).setVisible(true);
            }
        });
    }
