 ...
 * @author Prabudha
 */
public class SalesOrderDetailPicker2 extends javax.swing.JFrame {
    SalesOrder ob1;
    Connection con = null;
     ...
     */
    public SalesOrderDetailPicker2(SalesOrder ob1) {
       this.ob1 = ob1;
        initComponents();
    ...
    public void tableload(){
        ...
        try {
            ...
            Logger.getLogger(SalesOrderDetailPicker2.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void btnCusPickActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCusPickActionPerformed
        String cd = txtCusPick.getText();
        ob1.setCD(cd);// call for Sales Order itemCode set Method
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SalesOrderDetailPicker2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SalesOrderDetailPicker2(new SalesOrder()).setVisible(true);
            }
        });
    }
