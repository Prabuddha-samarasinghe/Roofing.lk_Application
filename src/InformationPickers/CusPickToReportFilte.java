...
import MainInterfaces.reportFilter;
 ...
 * @author Prabudha
 */
public class CusPickToReportFilte extends javax.swing.JFrame {
    reportFilter ob1;
    Connection con = null;
     ...
     */
    public CusPickToReportFilte(reportFilter ob1) {
        this.ob1 = ob1;
        initComponents();
    ...
    public void tableload(){
        ...
        String sql = "SELECT CustomerCode, CustomerName FROM customermaster";
        try {
            ...
            Logger.getLogger(CusPickToReportFilte.class.getName()).log(Level.SEVERE, null, ex);
        }
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGap(10, 10, 10)
                        .addComponent(txtCusPick, javax.swing.GroupLayout.PREFERRED_SIZE, 222, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(layout.createSequentialGroup()
                        .addGap(29, 29, 29)
    ...
    private void btnSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchActionPerformed
        ...
        String sql = "SELECT CustomerCode, CustomerName FROM customermaster where CustomerName LIKE '%"+ cusName  +"%' ";
        try {
            pst = con.prepareStatement(sql);
            rs = pst.executeQuery();
            jTable1.setModel(DbUtils.resultSetToTableModel(rs));
    ...
    private void btnCusPickActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCusPickActionPerformed
        String A = txtCusPick.getText();
        ob1.setF(A);// call for Sales Order itemCode set Method
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CusPickToReportFilte.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CusPickToReportFilte(new reportFilter()).setVisible(true);
            }
        });
    }
