 ...
 * @author Prabudha
 */
public class SalesOrderDetailPicker extends javax.swing.JFrame {
    SalesInvoice ob1;
    Connection con = null;
     ...
     */
    public SalesOrderDetailPicker(SalesInvoice ob1) {
       this.ob1 = ob1;
        initComponents();
    ...
    public void tableload(){
        ...
        String sql = "SELECT DocumentNo, DocumentDate,CustomerName,Status FROM salesorder WHERE Status = 'Open' ";
        try {
            ...
            Logger.getLogger(SalesOrderDetailPicker.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void btnSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchActionPerformed
        ...
        String sql = "SELECT DocumentNo, DocumentDate,CustomerName,Status FROM salesorder where CustomerName LIKE '%"+ cusName  +"%'AND Status = 'Open' ";
        try {
            pst = con.prepareStatement(sql);
            rs = pst.executeQuery();
            jTable1.setModel(DbUtils.resultSetToTableModel(rs));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SalesOrderDetailPicker.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SalesOrderDetailPicker(new SalesInvoice()).setVisible(true);
            }
        });
    }
