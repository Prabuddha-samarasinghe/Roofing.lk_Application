 ...
 * @author Prabudha
 */
public class itmPick2 extends javax.swing.JFrame {
   ...
   InventoryReceipt ob1;// check here
    ...
    public itmPick2(InventoryReceipt ob1) {
        setIconImage();
...
public void tableLoad(){
        ...
        try {
            ...
            Logger.getLogger(itmPick2.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    /**
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(itmPick2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new itmPick2(new InventoryReceipt()).setVisible(true);
            }
        });
    }
