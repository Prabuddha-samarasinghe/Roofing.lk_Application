 ...
 * @author Prabudha
 */
public class SalesInvoiceDetailPickeReportTo extends javax.swing.JFrame {
    reportFilter ob1;
    Connection con = null;
     ...
     */
    public SalesInvoiceDetailPickeReportTo(reportFilter ob1) {
       this.ob1 = ob1;
        initComponents();
    ...
    public void tableload(){
        ...
        try {
            ...
            Logger.getLogger(SalesInvoiceDetailPickeReportTo.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void btnCusPickActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCusPickActionPerformed
        String AB = txtCusPick.getText();
        ob1.setH(AB);// call for Sales Order itemCode set Method
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SalesInvoiceDetailPickeReportTo(new reportFilter()).setVisible(true);
            }
        });
    }
