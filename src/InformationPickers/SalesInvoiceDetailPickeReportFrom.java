 ...
 * @author Prabudha
 */
public class SalesInvoiceDetailPickeReportFrom extends javax.swing.JFrame {
    reportFilter ob1;
    Connection con = null;
     ...
     */
    public SalesInvoiceDetailPickeReportFrom(reportFilter ob1) {
       this.ob1 = ob1;
        initComponents();
    ...
    public void tableload(){
        ...
        try {
            ...
            Logger.getLogger(SalesInvoiceDetailPickeReportFrom.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void btnCusPickActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCusPickActionPerformed
        String AA = txtCusPick.getText();
        ob1.setG(AA);// call for Sales Order itemCode set Method
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SalesInvoiceDetailPickeReportFrom.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SalesInvoiceDetailPickeReportFrom(new reportFilter()).setVisible(true);
            }
        });
    }
