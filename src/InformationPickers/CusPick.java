 ...
 * @author Prabudha
 */
public class CusPick extends javax.swing.JFrame {
    SalesOrder ob1;
    Connection con = null;
    ...
    public void tableload(){
        ...
        String sql = "SELECT CustomerCode, CustomerName, Status FROM customermaster WHERE status = 'Active'";
        try {
            ...
            Logger.getLogger(CusPick.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void btnSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchActionPerformed
        ...
        String sql = "SELECT CustomerCode, CustomerName, Status FROM customermaster where CustomerName LIKE '%"+ cusName  +"%' AND Status = 'Active' ";
        try {
            pst = con.prepareStatement(sql);
            rs = pst.executeQuery();
            jTable1.setModel(DbUtils.resultSetToTableModel(rs));
    ...
    private void btnCusPickActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCusPickActionPerformed
        String t = txtCusPick.getText();
        ob1.setcode(t);// call for Sales Order itemCode set Method
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CusPick.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CusPick(new SalesOrder()).setVisible(true);
            }
        });
    }
