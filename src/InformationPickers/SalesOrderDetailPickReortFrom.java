 ...
 * @author Prabudha
 */
public class SalesOrderDetailPickReortFrom extends javax.swing.JFrame {
    reportFilter ob1;
    Connection con = null;
     ...
     */
    public SalesOrderDetailPickReortFrom(reportFilter ob1) {
       this.ob1 = ob1;
        initComponents();
    ...
    public void tableload(){
        ...
        String sql = "SELECT DocumentNo, DocumentDate,CustomerName,Status FROM salesorder ";
        try {
            ...
            Logger.getLogger(SalesOrderDetailPickReortFrom.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void btnSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchActionPerformed
        ...
        String sql = "SELECT DocumentNo, DocumentDate,CustomerName,Status FROM salesorder where CustomerName LIKE '%"+ cusName  +"% ";
        try {
            pst = con.prepareStatement(sql);
            rs = pst.executeQuery();
            jTable1.setModel(DbUtils.resultSetToTableModel(rs));
    ...
    private void btnCusPickActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCusPickActionPerformed
        String cde = txtCusPick.getText();
        ob1.setI(cde);// call for Sales Order itemCode set Method
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SalesOrderDetailPickReortFrom.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SalesOrderDetailPickReortFrom(new reportFilter()).setVisible(true);
            }
        });
    }
