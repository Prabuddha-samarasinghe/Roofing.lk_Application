 ...
 * @author Prabudha
 */
public class CusPickFromReportFilter extends javax.swing.JFrame {
    reportFilter ob1;
    Connection con = null;
     ...
     */
    public CusPickFromReportFilter(reportFilter ob1) {
        this.ob1 = ob1;
        initComponents();
    ...
    public void tableload(){
        ...
        try {
            ...
            Logger.getLogger(CusPickFromReportFilter.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void btnCusPickActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCusPickActionPerformed
        String Z = txtCusPick.getText();
        ob1.setE(Z);// call for Sales Order itemCode set Method
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CusPickFromReportFilter.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CusPickFromReportFilter(new reportFilter()).setVisible(true);
            }
        });
    }
