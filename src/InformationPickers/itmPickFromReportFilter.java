 ...
 * @author Prabudha
 */
public class itmPickFromReportFilter extends javax.swing.JFrame {
   ...
   reportFilter ob1;// check here
    ...
    public itmPickFromReportFilter(reportFilter ob1) {
        setIconImage();
...
public void tableLoad(){
        ...
        try {
            ...
            Logger.getLogger(itmPickFromReportFilter.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    /**
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(itmPickFromReportFilter.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new itmPickFromReportFilter(new reportFilter()).setVisible(true);
            }
        });
    }
